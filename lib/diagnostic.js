...
// Methods: add new calendar event to schedule, delete event from schedule,
// share event with another user

// Entity: calendar event
// Attributes: date, time, place, description
// Methods: alter details of event (date/time/place/description)
