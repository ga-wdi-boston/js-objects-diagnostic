...
// Answer Starts Here
// Desctiption: A browser-based calendar
//Entity: Event
//Attributes: date, time, location
//Methods: addEvent, deleteEvent(), rescheduleEvent()
//
//Entity: calendar owner
//Attributes: email, name, DOB, timezone
//Methods: sendsInvitation()
...
let owner = new Object()
  owner.name =  'Angie Woodrum',
  owner.address = '8 Winter Street',
  owner.numOfPets = 2
...
const labPuppy = new Pet('Henry', 'dog', 'lab', 'barks')

console.log(labPuppy.vocalize())
