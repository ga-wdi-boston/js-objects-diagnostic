...
Pet.prototype.makeNoise = function makeNoise () { //I think I am misunderstanding why we need a function here if the pet noise is already a unique attribute that we defined in Q3
  return this.noise;
};
