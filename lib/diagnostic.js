...
// Description: User
// Entity: Account
// Attributes: Name, email, availability, time zone
// Methods: assign to meeting, send notification email, reset password
//
// Description
// Entity: calendar
// Attributes: dates, time, meeting objects, description for meetings
// Methods: schedule meeting, cancel meeting, invite Users to meetings
// Answer Ends Here
...
const Pet = function Pet (name, species, breed, vocalization) {
  ...
  this.vocalize = function (vocalize) {
...
const pet = new Pet('Jamison', 'dog', 'mix', 'bark')
