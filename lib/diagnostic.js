...
// Answer Starts Here
// Description: Our app tracks schedules through an online calendar.
// Entity: Event
// Attributes: name, date, description, attendees, place
// Methods: changeTime, changeDate, changePlace
//
// Entity: User
// Attributes: name, events
// Methods: rsvp, scheduleEvent
// Answer Ends Here
...
let owner = {
  name: 'Bob Bobson',
  address: '1 Main Street, Small Town',
  numberOfPets: '2',
};
...
let pet = {
  ...
  species: 'Dog',
  breed: 'Shiba Inu',
  vocalization: 'such ruff. wow. very bark.',
