...
// Answer Starts Here
  ...
  var some_pet = {
    ...
    makeNoise : function (noise) {
      // so, the below var uniquNoise statments are redundant
      // because we can just do a console.log
      // when the makeNoise method is invoked, yes?

      // var uniqueNoise = noise;
      // return uniqueNoise;

      // and this is more appropriate, yes?
