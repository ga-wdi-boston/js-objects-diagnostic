...
Methods: switchUser ,createAppt

Entity: Appointment
Attribute: date , time , tile, location
Methods: addAlert , ModifyAppt, DeleteAppt
...
owner.name = "DJ Pet Master";
owner.address = "Bahston";
owner.numberOfPets = 15;
...
let pet = {}
  ...
  pet.species = "dog";
  pet.breed = "Corgi";
  pet.vocalization = "bark";
  pet.vocalize = function() {
    return  pet.vocalization;
  };
