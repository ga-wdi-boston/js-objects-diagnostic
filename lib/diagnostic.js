...
// Answer Starts Here
  Description: browser-based program that manages gym workouts

  Entity: weightBench
  Attributes: type weights used, how heavy the weights
  Methods: time, reps,

  Entity: workoutPerson
  Attribute: name, weight, age
  Method: average mile on tredmill, average weights benched
