...
// Answer Starts Here
  Description: Calendar Object/calendar displays events
  Entity: calendar
  Attributes: Date (Day, Month Year), Event
  Methods: GetDate, SetDate, GetEvent, SetEvent

  Entity: event
  Attributes: Date, Description, Type, Leader
  Methods: SetDate, SetDescription, SetType, SetLeader, GetDate, GetDesciption,
  getType, getLeader
// Answer Ends Here
...
let owner = {
  name: 'Jon Cohen',
  address: '48 Strathmore Road, Boston',
  numberOfPets: 2
};
...
const Pet = function (name, species, breed, vocalization) {
  ...
  this.breed = breed
  this.vocalization = vocaliaztion
};
