...
// Answer Starts Here
// Entity: Calender
// Attributes: Month, Day, Week,
// Methods: create event, delete event, alert about event
//
// Entity: event
// Attributes: Date, time, notes
// Methods: Alter Event, alert about event, invite people to event.
// Answer Ends Here
...
const owner = {
  name: "Paddy O'Rourke",
  address: "When she's feeling generous, his girl's place in Dorchestah",
  numberOfPets: 1
}
