...
// Answer Starts Here
// Description: A browser-based calendar program.
// Entity: Calendar
// Attributes: days, months, year
// Methods: createEvent, DeleteEvent, EventHistory
//
// Answer Ends Here
// Entity: CalendarUser
// Attributes: name, DeviceType
// Methods: create, delete, history
...
console.log("The pet " + this.name + "and of breed " + this.breed);
} ;
