...
// Answer Starts Here
// Enity: user
// Attributes: email, user name, assignedTasks
// Methods: printOverDueTasks onTrackCheck, listComplete

// Entity: birthday
// Attributes: date, whoseBday, presentIdeas
// Methods: rememberToBuyPresent, sendCard
// Answer Ends Here
...
let owner = {
  name: 'Owner McStuffenface',
  address: '555 Comercial Ave Drive',
  numberOfPets: 1
};
...
const lucy = new Pet ('lucy', 'kitten', 'adorable', 'meow')
