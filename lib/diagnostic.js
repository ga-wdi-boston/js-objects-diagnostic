...
// Answer Starts Here
//Description: Out program manages fitness and health done on each day
//Entity: Person
//Attributes: Height, weight, age
//Methods: input new workout, calculate calories burnt, caclulate water drank
// Answer Ends Here
...
let pet = {
  ...
  vocalization: "Yap! Yap!",
  vocalize: function (){
    console.log(pet.vocalization);
  }
};
...
Pet.prototype.vocalize = function() {
  console.log(this.name+ " says " +this._vocalization)
}
