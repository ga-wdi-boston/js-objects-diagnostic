...
// Answer Starts Here
  Description: The app manages your schedule and to-dos

  Entity: calendar
  Attributes: year, month, day, time
  Methods: schedule events, schedule to-do lists, set time schedule

  Entity: To-Do List
  Attributes: to-do,checklist
  method: add to-do list, add checklist.
// Answer Ends Here
