...
Entity: event
Attribute: Day, Month, Year, Time, event name, event location
Methods: create event, delete event, modify event

Entity: User
Attributes: username, email, password
Methods: navigate events
*/
// Answer Ends Here
...
let owner = {
  name: 'Steve Wisner',
  address: '250 Arborway, Boston, MA 02130',
  numberOfPets: 0,
};
...
let pet = {
  ...
  vocalization: 'Vocalization Attribute',
  vocalize: function() {}
};
