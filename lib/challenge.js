...
// Answer Starts Here
// 'Calendar'
// Description : Our app manages events on a calendar.
// Every 'calendar' has
// - a Year
// - a Month (each Year has these)
// - a Week (each Month has these)
// - a Day (each Week has these)
// Every 'calendar' can
// - create an event
// - delete an event
// - say the current date (Month/Day/Year)
// - say the next event in the current day
// Answer Ends Here
