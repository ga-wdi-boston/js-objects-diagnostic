...
/*
Entity: Calender
Attributes: day, month, year, time
Methods: onScheduleToday(user) = Whats on your schedule today

Entity: User
Attributes: name, schedule
Methods: addEvent = Adds an event to the calender,
busyToday = Are you busy today
*/
// Answer Ends Here
...
let pet = {
  name: 'Mr. kitty',
  species: 'Cat',
  breed: 'Dont know any breeds',
  vocalization: 'Feed Me Meow!!!',
