...
//Attributes: name, calendar types (home, work)
//Methods: add new calendar type, update profile

//Entity: Appointment
//Attributes: startTime, endTime, name
//Methods: add, update
// Answer Ends Here
...
let owner = {
  name: 'danielle',
  address: '10 Maplewood Avenue Dover, NH',
  numberOfPets: 3
  };
...
let pet = {
  name: 'Blitz',
  species: 'cat',
  breed: 'flame-point himmy',
  vocalization: 'loud meows'};
...
const prince = new Pet('princeton', 'cat', 'long hair', 'baby meows')
