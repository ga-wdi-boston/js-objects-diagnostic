...
// Answer Starts Here
It would need a object for the cars,

 it would need a method for keeping track of
the number of sales, and to keep track of calls recieved
//
// Answer Ends Here
...
const Pet = function new(name, species, breed, vocalization) {
      this.Name = name;
