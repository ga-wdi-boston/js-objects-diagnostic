...
//Entity: User
//Attributes: name, email address, location (time zone)
//Methods: addEvent, blockTime, showSchedule (array of Events for specific date)

//Entity: Event
//Attributes: date, category, start time, end time, description
//Methods: reschedule (update date & time), addAlarm
// Answer Ends Here
...
let owner = {
  name: 'Sarah',
  address: '175 Lincoln St, Manchester, NH',
  numberOfPets: 2
};
