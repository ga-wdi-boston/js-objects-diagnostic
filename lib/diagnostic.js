...
Entity: Event
Attributes: Time, date, Description, location
Methods: Add event, delete event, edit event

Entity: Contact
Attributes: name, phone number, address, email address
Method: invite to event
...
/* your answer here */
Pet.prototype.vocalization = vocalization;
// Don't change this
module.exports = {
  answerTwo: owner,
  answerThree: pet,
