...
// Answer Starts Here
/*Description: Our app is a browser based calendar

Entity: Appointment
Attributes: date, time, urgency, description
Methods: alertUser, remindUser, rescedule

Entity: Alarm
Attributes: time, day(s), sound
Methods: set, shutOff, repeat*/
