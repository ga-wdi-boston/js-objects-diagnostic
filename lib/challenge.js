...
// Answer Starts Here
  'calendar'
  Description: a calendar app that keep track of things for users
  Every calendar has:
    - a user
    - a date
    - a time
    - an event
  Every calendar can:
    - add/delete new date/time/event
    - set reminder before event date/time
    - invite other user to certain events
