...
// Answer Starts Here
// Description: Our calendar manages events.
// Entity: Event
// Attributes: Date, Time, Duration, Description, list of Attendees
// Methods: getters (Date, time, description etc), setters (same), addPerson(), changeDescription()

// Entity: Person
// Attributes: Name, job, email address, events
// Methods: getters, setters, addEvent(), editEvent(), shareEvent()
// Answer Ends Here
