...
Entity: User
Attributes: name
Methods: createEvent, deleteEvent

Entity: Event
Attributes: description, startTime, location, duration
Methods: alert, remind, repeat
// Answer Ends Here
...
let pet = {
      ...
      vocalization: 'woof',
      vocalize: function(){
        return 'my name is ' + this.name + ' and i say ' + this.vocalization;
      }
    };
