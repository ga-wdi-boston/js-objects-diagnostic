...
// Answer Starts Here
// Year:
//   Attributes: months > days > event: { date, time, description ]
//   Methods: findEvent(), findDate()
//
// User:
//   Attributes: Name, email, address
//   Methods: findUser(), updateUserEmail(), updateUserAddress()
...
let owner = {
  name: 'Lindsey Curran',
  address: '35 Chestnut Hill Ave Brighton MA 02135',
  numberOfPets: 1
};
