...
// Answer Starts Here
```md
Description: Our app is a browser-based calendar program
Entity: Event
Attributes: date, time, location, attendeeList
Methods: invitePerson, emailAttendees

Entity: Day
Attributes: date, eventList
...
let owner = {
  name: 'Misha',
  address: '28 Cambridge Street, Apartment 3, Cambridge MA, 02139',
  numberOfPets: 1
};
...
// Replace null with your answer
let pet = {
  name: 'Moonlight aka Moopy',
  species: 'cute doge',
  breed: 'American Eskimo',
  vocalization: 'grrr bark BARK',
  vocalize: function(){
