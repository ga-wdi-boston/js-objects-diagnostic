...
// Answer Starts Here
// Entity: User
// Attributes: name, logIn, preferences
// Methods: freeTime, nextDayOff, clearDay
//
// Entity: Developer
// Attributes: name, accessLevel, numberOfUsers,
// Methods: restrictAccess, banUser 
//
// Answer Ends Here
...
const Pet = function(name, species, breed, vocalization) {
  ...
  this.breed = breed;
  this.vocalization = function(sound){
    return sound;
  };
};
...
Pet.prototype.vocalize = function(sound){
  return sound;
};
