...
'Calendar'
// Description: Our app manages a user's appointments.
// Every 'calendar has
// - a note
// - a date
// - a time
// Every 'calendar' can
// - send an alert
// - not let you book two appointments at the same time.
...
var some_pet = {
  ...
  breed: "Lab",
  noise: = function () {
    return "I'm a" + species + "I say Woof Woof.";
}
}
...
//I am not sure how to make a method called makeNoise to behave the way question 3 does. I will research this when I have more time then alotted for this assessment and submit again.
