...
//Methods: putMeeting, deleteMeeting
// Answer Ends Here
...
let owner = {
  name: "James",
  address: "55 Magazine Street, Berlin 097652, Africa",
  numberOfPets: 6
}
...
// to create a new pet type:
//let cat = new Pet('Filou','cat','mixed','miau');
// or
// let hamster = new Pet('Cherley','hamster','nager','nup nup');
...
//to use the vocalize method type: cat.vocalize();
// the vocalize method is not working- why? Could you please explain? Thanks.
