...
Entity: ToDoItem
Attributes: description, dueDate, completed, notification
Methods: complete, editDescription, editNotification, editDueDate, share

Entity: Notification
Attributes: sound, message, date, associatedItem
Method: editSound, editMessage, mute
...
let owner = {
  name: 'Frederick Bimblebottom',
  address: '39 Bumburry Lane',
  numberOfPets: 26,
}
