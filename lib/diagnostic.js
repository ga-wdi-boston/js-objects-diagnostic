...
// Answer Starts Here
//description: online app for managing or keeping track of things
//Entity: User
//Attributes: Name, email
//Methods: Add 'To-do' items

//Entity: 'To-do' items
//Attributes: title, date, notes, reminders setting
//Methods: CRUD item from list
// Answer Ends Here
...
/* your answer here */
var Pet = new Pet ('david', 'new species name', 'etc.')
// Don't change this
module.exports = {
  answerTwo: owner,
  answerThree: pet,
