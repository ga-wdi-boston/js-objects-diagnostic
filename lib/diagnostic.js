...
// Answer Starts Here
// DescriptionL Our app manages a schedule
// Entity: User
// Attributes: name, email, schedule
// Methods: addScheduleItem, getAgendaForDay
//
// Entity: ScheduleItem
// Attributes: date, time, itemName, itemDescription
// Answer Ends Here
...
let owner = {
  name: 'Angela',
  address: '123 Main St., Boston, MA 02109',
  numberOfPets: 2
};
