...
Pet.prototype.vocalize = function() {
  return 'WOOF!'; // should be return this.vocalization
};                 // returning just WOOF would mean any Pet object that was
                    // created with the Pet constructor would return woof when called.
