...
// Answer Starts Here
// Description: A browser-based calendar program to keep track of things.
// Entity 1:  Event
// Attributes:  Event title, Event calendar (i.e. work, home), start day,
//  start time, end day, end time, location, reoccurrence, reminderNotification
// Methods: setEventTitle, getLocation, calculateEventDuration, setLocation
//
// Entity 2:  CalendarDisplay
// Attributes: Year, Month, Day, Hour, Minute, Day View, 3 Day View, Week View,
//  Month View
// Methods: setHour, showDayView, showWeekView, changeView
// Answer Ends Here
