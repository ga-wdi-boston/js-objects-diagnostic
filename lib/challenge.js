...
/* 'Calendar'
description: manages appointments(events)
Every calendar has:
-dates
-events
-notifications
...
'notifications' tell the user:
-a time to notify the user (relative to the event)
-the way the user is notified (pop-up/email/etc)
-the event date/time
*/
...
some_pet = {
    ...
    breed: "greyhound",
    noise: 'sigh',
    makeNoise: function(){return: this.name + this.noise + 'ed'}
...
Pet.prototype.makeNoise = function(){
  return: this.name + this.noise + 'ed';
}
// Answer Ends Here
