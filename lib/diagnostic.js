...
// Methods: printAgenda (accepts date, returns all events on that date)

// Entity: Event
// Attributes: date, startTime, endTime, name, location
// Methods: edit (changes any or all of the attributes), delete
// Answer Ends Here
