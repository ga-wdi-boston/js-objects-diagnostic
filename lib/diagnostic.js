...
Entity: Event Information
  Attributes: Subject, location, date, time

Entity: Recurrence Information
  Attributes: Day of recurrence, time of recurrence
  Methods: setRecurrenceFrequency

Entity: Sharing Event
  Attributes: Name of Invite Recipient, Email of Invite Recipient
  Method: sendInvite
// Answer Ends Here
...
let owner = {
  name: 'Nari',
  address: '51 Walker Street Cambridge, MA 02138',
  numberOfPets: 1
}
...
const Jyo = new Pet('Jyo', 'cat', 'breed', 'meow')
