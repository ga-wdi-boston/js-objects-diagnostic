...
'Calendar'
Decription: Our app keeps track of events for day.
1) Every Calendar has:
a) Dates
b) Hour markers
c) Months

2) Every calendar can:
a) Add events
b) Alert before an event
c) Repeat events at specified intervals
...
var pet_owner = {
  name: "Jeff Meyer"
  email: "160 Quincy Shore Drive, Quincy MA 02171"
};
// Answer Ends Here
...
var Pet;
// Answer Starts Here
var Pet = function getPetInfo(name, species, breed, noise) = {
  this.name = name;
