...
// Answer Starts Here
const Car = function Car (make, model, year) {
  this.make = make;
  this.model = model;
  this.year = year;
};
const SalesPerson = function SalesPerson (name, commissionRate) {
  this.name = name;
  this.commissionRate = commissionRate;
};
// Not sure what to do with the methods
// Answer Ends Here
...
let owner = function (name, address, pets) {
  this.name = name;
